...
- ```eraserDiameter```: an integer, the diameter in pixels affected by the eraser. Larger values - ```smallDefaultCursors```: Use smaller default cursors for chalks, pen and eraser.
erase a greater area. The erased area is circular.
